...
```python
# Configure the LLM API in the .env file in the same-level folder. You can refer to the .env in the code folder, or reuse the .env file from previous chapter cases.
